...
const SidebarTheme = {
  ...
  item: {
    base: 'flex items-center justify-center rounded-lg p-2 text-leftNavText font-normal text-leftNavText hover:text-black hover:bg-white dark:text-white dark:hover:bg-gray-700',
